                ...
                <div class="row align-items-center">
                    <div class="col pl-5">
                        <Select
                            ...
                            smallId="" smallTxt="Seleccione un tipo" size={0} />
                    </div>
                    ...
                    <div class="col pr-5">
                        <Input
                            ...
                            icon="description" id="" placeholder="Producto" type="text" />
                    </div>
                </div>
                <div class="row align-items-center">
                    <div class="col pr-5 pl-5">
                        <Input
                            ...
                            icon="text_rotation_none" id="" placeholder="Valor consecutivo" type="text" />
                    </div>
                    <div class="col pl-5 pr-5">
                        <Input
                            smallId="" smallTxt="Prefijo"
                            icon="short_text" id="" placeholder="Prefijo" type="text" />
                    </div>
                </div>
