...
import Nuevo_Tipo_Materia_Prima from '../forms/Nuevo_Tipo_Materia_Prima';
...
import Materia_Prima from '../tables/Materia_Prima'
import Tipo_Materia_Prima from '../tables/Tipo_Materia_Prima'
    ...
    render() {
        return (
            <div>
                ...
                <Route path="/administracion/tipo-materia-prima" exact component={Tipo_Materia_Prima} />
                ...
                <Route path="/administracion/nuevo-tipo-materia-prima" exact component={Nuevo_Tipo_Materia_Prima} />
